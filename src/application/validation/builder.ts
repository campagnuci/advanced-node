import { Required, RequiredString, RequiredBuffer, Validator, AllowedMimeTypes, AllowedExtension, MaxFileSize } from '@/application/validation'
...
export class ValidationBuilder {
  ...
  image ({ allowed, maxSizeInMb }: { allowed: AllowedExtension[], maxSizeInMb: number }): ValidationBuilder {
